window.onload = async ()=> {
    ...
    async  (event)=> {
        ...
        let estado = document.getElementById("estado").value.trim().toLowerCase();
    ...
    async  (event)=> {
        ...
        let nome = document.getElementById("nome_edit").value.trim().toLowerCase();
        let data_nascimento = document.getElementById("data_nascimento_edit").value;
        let cpf = document.getElementById("cpf_edit").value.trim();
        let rg = document.getElementById("rg_edit").value.trim();
        let telefone = document.getElementById("telefone_edit").value.trim();
        let cep = document.getElementById("cep_edit").value.trim();
        let rua = document.getElementById("rua_edit").value.trim();
        let estado = document.getElementById("estado_edit").value.trim().toLowerCase();
        let cidade = document.getElementById("cidade_edit").value.trim().toLowerCase();
